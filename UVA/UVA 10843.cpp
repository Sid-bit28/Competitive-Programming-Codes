...
#endif
lli binpow(lli b,lli p,lli mod=MOD){lli ans=1;b%=mod;for(;p;p>>=1){if(p&1)ans=(__int128)ans*b%mod;b=(__int128)b*b%mod;}return ans;}

const lli mod=2000000011;
void pre(){
